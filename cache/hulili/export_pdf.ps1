# export_pdf.ps1 — Build master HTML + export Hu Li Li's report PDF
...
$outPdf = Join-Path $outDir "Hu-Li-Li-胡莉莉-1964-05-05.pdf"
...
<head>
<meta charset="UTF-8">
<title>Hu Li Li — Laporan Ramalan Lengkap (PDF)</title>
...
$masterFile = "$src\report_hulili_full.html"
...
$tempPdf = Join-Path $env:TEMP ("hulili_pdf_" + [guid]::NewGuid().ToString().Substring(0,8) + ".pdf")
