...
**ATURAN STRICT:**
1. Hitung jumlah `。` (titik full-width) di foto sumber.
2. Hitung jumlah `。` (atau klausa setara) di insight MD.
3. Target rasio: **≥80%** (jumlah insight / jumlah foto).
4. Multi-paragraf foto → translate **SEMUA paragraf**, jangan drop P2/P3/P4/P5.
5. Klausa kondisional (`如與X同宮`, `位於Y之宮內`) WAJIB diterjemahkan, jangan dianggap "kondisional jadi skip".
6. Self-check sebelum exit: re-read foto sumber, pastikan tiap konsep ada di insight.
