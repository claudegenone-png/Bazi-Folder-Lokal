...
TRIGRAMS = {
    "坎": {"symbol": "☵", "pinyin": "Kǎn", "label_id": "Air",    "dir_id": "Utara",     "dir_abbr": "U",  "dir_cn": "北",    "group": "Timur", "pos": "N",
           "desc_id": "Elemen Air — mengalir, menembus, adaptif. Kelompok Timur (東四命): cermat, intuitif, dan tekun dalam menghadapi rintangan."},
    "艮": {"symbol": "☶", "pinyin": "Gèn", "label_id": "Gunung", "dir_id": "Timur Laut","dir_abbr": "TL", "dir_cn": "東北", "group": "Barat", "pos": "NE",
           "desc_id": "Elemen Tanah-Gunung — kokoh, diam, teguh. Kelompok Barat (西四命): stabil, sabar, dan memiliki daya tahan jangka panjang."},
    "震": {"symbol": "☳", "pinyin": "Zhèn","label_id": "Petir",  "dir_id": "Timur",     "dir_abbr": "T",  "dir_cn": "東",    "group": "Timur", "pos": "E",
           "desc_id": "Elemen Kayu-Petir — dinamis, penuh inisiatif, gerak maju. Kelompok Timur (東四命): berani, visioner, dan cepat mengambil tindakan."},
    "巽": {"symbol": "☴", "pinyin": "Xùn", "label_id": "Angin",  "dir_id": "Tenggara",  "dir_abbr": "TG", "dir_cn": "東南", "group": "Timur", "pos": "SE",
           "desc_id": "Elemen Kayu-Angin — fleksibel, penetratif, komunikatif. Kelompok Timur (東四命): luwes, persuasif, dan pandai membangun jaringan."},
    "離": {"symbol": "☲", "pinyin": "Lí",  "label_id": "Api",    "dir_id": "Selatan",   "dir_abbr": "S",  "dir_cn": "南",    "group": "Timur", "pos": "S",
           "desc_id": "Elemen Api — bercahaya, ekspresif, karismatik. Kelompok Timur (東四命): cerdas, penuh semangat, dan menonjol di lingkungan sosial."},
    "坤": {"symbol": "☷", "pinyin": "Kūn", "label_id": "Bumi",   "dir_id": "Barat Daya","dir_abbr": "BD", "dir_cn": "西南", "group": "Barat", "pos": "SW",
           "desc_id": "Elemen Bumi — mengayomi, setia, penuh perhatian. Kelompok Barat (西四命): sabar, dapat diandalkan, dan kuat dalam memelihara hubungan."},
    "兌": {"symbol": "☱", "pinyin": "Duì", "label_id": "Danau",  "dir_id": "Barat",     "dir_abbr": "B",  "dir_cn": "西",    "group": "Barat", "pos": "W",
           "desc_id": "Elemen Logam-Danau — menyenangkan, tajam, elegan. Kelompok Barat (西四命): ekspresif, diplomatis, dan memiliki daya tarik sosial tinggi."},
    "乾": {"symbol": "☰", "pinyin": "Qián","label_id": "Langit", "dir_id": "Barat Laut","dir_abbr": "BL", "dir_cn": "西北", "group": "Barat", "pos": "NW",
           "desc_id": "Elemen Logam-Langit — memimpin, tegas, berwibawa. Kelompok Barat (西四命): natural leader, bertanggung jawab, dan berorientasi pada prestasi."},
}
