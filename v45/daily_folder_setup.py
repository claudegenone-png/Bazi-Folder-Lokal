...
Usage:
    python v45/daily_folder_setup.py

Output:
    foto/database/{DD-MM-YYYY}/
        ├── 1/
        ├── 2/
        ...
        └── 10/
...
Atau run manual setiap kali mau mulai daily render.
"""
from pathlib import Path
from datetime import date


FOTO_BASE = Path(r"C:\Users\sukam\OneDrive\Documents\Ramalan\foto\database")
...
def setup_daily_folder(target_date: date | None = None) -> Path:
    ...
    print(f"     trigger di window baru: '{daily_dir}\\{{N}} pakai V4.5'")
    return daily_dir
